...
class SubnetElementTest < Test::Unit::TestCase
  ...
  def test_create_list_delete_subnet_elements
    ...
    reservations = @api.list_subnet_elements(@subnet_1, DhcpsApi::DHCP_SUBNET_ELEMENT_TYPE::DhcpReservedIps)
    ...
    ranges = @api.list_subnet_elements(@subnet_1, DhcpsApi::DHCP_SUBNET_ELEMENT_TYPE::DhcpIpRanges)
    ...
    assert_equal 0, @api.list_subnet_elements(@subnet_1, DhcpsApi::DHCP_SUBNET_ELEMENT_TYPE::DhcpReservedIps).size
    assert_equal 0, @api.list_subnet_elements(@subnet_1, DhcpsApi::DHCP_SUBNET_ELEMENT_TYPE::DhcpIpRanges).size
  ensure
